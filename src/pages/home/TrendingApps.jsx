  ...
  return (
    ...
    <div className="p-4 bg-white shadow-lg rounded-lg">
      ...
      <div className="flex justify-between mt-4">
        <button className="flex gap-1 items-center rounded-sm  p-2 bg-[#F1F5E8] border-none text-[#00D390] font-medium
        ">
          <FiDownload /> {downloads}
        </button>
        <button  className="flex gap-1 items-center rounded-sm  p-2 bg-[#FFF0E1] border-none text-[#FF8811] font-medium
        ">
          <FaStar /> {ratingAvg}
        </button>
      </div>
